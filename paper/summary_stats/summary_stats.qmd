...
ggsave("../paper/images/n_sitting_days_per_year.png",  width=8, height=5)
```
...
#ggsave("../paper/images/n_unique_speakers_per_day.png", width=8, height=5)
```
...
ggsave("../paper/images/n_unique_speakers_per_day_gender.png", width=8, height=5)
```
...
#ggsave("../paper/images/n_speakers_per_yr_gender.png", width=8, height=5)
```
...
ggsave("../paper/images/n_interject_per_yr.png", width=8, height=5)
```
